...
namespace DataBridge.Extensions
{
    public static class DateTimeExtensions
    {
        ...
        /// <summary>
        /// Determines whether [is in time range] [the specified start].
        /// </summary>
        /// <param name="toCheck">To check.</param>
        /// <param name="start">The start.</param>
        /// <param name="end">The end.</param>
        /// <returns>
        ///   <c>true</c> if [is in time range] [the specified start]; otherwise, <c>false</c>.
        /// </returns>
        public static bool IsInTimeRange(this TimeSpan toCheck, TimeSpan start, TimeSpan end)
        {
            if (start <= end)
            {
