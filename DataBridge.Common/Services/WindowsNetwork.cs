...
namespace DataBridge.Services
{
    ...
    ///
    ///   var existsPath = WindowsNetwork.IsPathAvailable(@"\\BDL-FRA-ASP02\develop");
    /// var errorText = WindowsNetwork.ConnectRemote(@"\\BDL-FRA-ASP02\develop", @"BDL\tlauzi", "", "Y:");
    /// WindowsNetwork.DisconnectRemote(@"\\BDL-FRA-ASP02\develop");
    /// </summary>
