...
{
    public class WmiServiceInstaller
    {
        private static readonly WmiServiceInstaller instance = new WmiServiceInstaller(new WmiAccess());

        static WmiServiceInstaller()
        {
        }

        private WmiServiceInstaller()
        {
        }

        public static WmiServiceInstaller Instance
        {
            get { return instance; }
        }
        ...
        /// <summary>
        /// Creates a new WmiServiceInstaller for use to access Windows Services
        /// </summary>
        /// <param name="wmi">The WMI access object - the tool that does the low level work</param>
        public WmiServiceInstaller(IWmiAccess wmi)
        {
            this.wmi = wmi;
        }
