...
{
    [DataCommandDescription(Name = "ExcelWriter", Title = "ExcelWriter", Group = "Connectors", Image = "\\Resources\\Images\\ExportConnector.png", CustomControlName = "DataExportAdapterControl")]
    public class ExcelWriter : DataCommand
    {
